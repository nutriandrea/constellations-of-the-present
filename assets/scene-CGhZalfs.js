...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function so(e,t,n){let r=new Float32Array(qa),i=new J(0,1,0);return new Vi({name:`SphericalGaussianBlur`,defines:{n:qa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:uo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function co(){return new Vi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:uo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function lo(){return new Vi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:uo(),fragmentShader:`
	...
	`}var fo=class extends Et{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ei(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},cl=class e extends Qc{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new q(256,256):new q(e.x,e.y),this.clearColor=new Z(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new Et(i,a,{type:v}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new Et(i,a,{type:v});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new Et(i,a,{type:v});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=sl;this.highPassUniforms=Ri.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new Vi({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new q(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new J(1,1,1),new J(1,1,1),new J(1,1,1),new J(1,1,1),new J(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=Ri.clone(Zc.uniforms),this.blendMaterial=new Vi({uniforms:this.copyUniforms,vertexShader:Zc.vertexShader,fragmentShader:Zc.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new Z,this._oldClearAlpha=1,this._basic=new Ir,this._fsQuad=new tl(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new q(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);return new Vi({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new q(.5,.5)},direction:{value:new q(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`
				...
				}`})}};cl.BlurDirectionX=new q(1,0),cl.BlurDirectionY=new q(0,1);var ll={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},ul=class extends Qc{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ri.clone(ll.uniforms),this.material=new Hi({name:ll.name,uniforms:this.uniforms,vertexShader:ll.vertexShader,fragmentShader:ll.fragmentShader}),this._fsQuad=new tl(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},X.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}};new Z(16763210),new Z(10475775),new Z(7044054),new Z(16734798),new Z(14723071),new Z(13621475);function dl(e,t){return t*(1+Math.min(e/6e4,1)*.2)}function fl(e){let t=2166136261;for(let n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return t>>>0}function pl(e){let t=e;return()=>{t+=1831565813;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function ml(e,t=2.2){let n=pl(fl(e)),r=n(),i=n(),a=1-2*r,o=Math.sqrt(Math.max(0,1-a*a)),s=2*Math.PI*i;return{x:t*o*Math.cos(s),y:t*a,z:t*o*Math.sin(s)}}var hl=.85;function gl(e){let t=Math.max(.1,e),n=30*Math.PI/180,r=Math.tan(n)*t;return Math.min(Math.tan(n),r)*5*hl}function _l(e,t){return Math.hypot(e.x-t.x,e.y-t.y,e.z-t.z)}function vl(e,t){return e<t?`${e}|${t}`:`${t}|${e}`}function yl(e,t,n){let r=new Map;for(let i of e){let a=e.filter(e=>e.id!==i.id).map(e=>({b:e,d:_l(i,e)})).filter(({d:e})=>e<=t).sort((e,t)=>e.d-t.d||(e.b.id<t.b.id?-1:1)).slice(0,Math.max(1,n));r.set(i.id,a)}let i=[],a=new Set;for(let n of e){let e=r.get(n.id)??[];for(let o=0;o<e.length;o++){let{b:s,d:c}=e[o],l=vl(n.id,s.id);if(a.has(l))continue;let u=r.get(s.id)??[],d=u.some(e=>e.b.id===n.id),f=o===0,p=u.length>0&&u[0].b.id===n.id;if(!d&&!f&&!p)continue;a.add(l);let m=Math.max(0,1-c/t);i.push({a:n.id,b:s.id,ax:n.x,ay:n.y,az:n.z,bx:s.x,by:s.y,bz:s.z,opacity:m**1.6})}}return i.sort((e,t)=>t.opacity-e.opacity||(vl(e.a,e.b)<vl(t.a,t.b)?-1:1)),i}function bl(e=900,t=1400){let n=new Map;return{sync(e){let t=new Set;for(let r of e){let e=vl(r.a,r.b);t.add(e);let i=n.get(e);i?(i.connection=r,i.target=1):n.set(e,{connection:r,alpha:0,target:1})}for(let[e,r]of n)t.has(e)||(r.target=0)},step(r){let i=[],a=r/Math.max(1,e),o=r/Math.max(1,t);for(let[e,t]of n){if(t.target>t.alpha?t.alpha=Math.min(1,t.alpha+a):t.target<t.alpha&&(t.alpha=Math.max(0,t.alpha-o)),t.alpha<=0&&t.target===0){n.delete(e);continue}let r=t.alpha*t.alpha*(3-2*t.alpha);i.push({...t.connection,alpha:r})}return i.sort((e,t)=>t.opacity*t.alpha-e.opacity*e.alpha),i},size(){return n.size}}}var xl=.16;function Sl(e,t,n,r={x:0,y:0,z:0}){let i=(e.x+t.x)/2,a=(e.y+t.y)/2,o=(e.z+t.z)/2,s=Math.hypot(e.x-t.x,e.y-t.y,e.z-t.z),c=i,l=a,u=o,d=Math.hypot(c,l,u);d<1e-6&&(c=-(e.y-t.y),l=e.x-t.x,u=0,d=Math.hypot(c,l,u),d<1e-6&&(c=0,l=0,u=1,d=1));let f=s*xl*2/d,p=i+c*f,m=a+l*f,h=o+u*f,g=1-n,_=g*g,v=2*g*n,y=n*n;return r.x=_*e.x+v*p+y*t.x,r.y=_*e.y+v*m+y*t.y,r.z=_*e.z+v*h+y*t.z,r}function Cl(e){return Math.sin(Math.PI*Math.min(1,Math.max(0,e)))**.65}function wl(e,t){return Math.min(1,Math.max(0,(t-e)*7+1))}function Tl(e,t,n=.55){let r=Math.abs(e-t);return r>.5&&(r=1-r),1+n*Math.exp(-(r*r)/.006)}function El(e,t,n=5200){let r=Math.abs(Math.sin(t*12.9898))*1e3%1;return((e/n+r)%1+1)%1}function Dl(e){let t=2166136261;for(let n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return(t>>>0)/4294967295}function Ol(e){return e-Math.floor(e)}function kl(e){let t=Ol(Math.sin(e*12.9898)*43758.5453),n=Ol(Math.sin(e*78.233)*24634.6345),r=Ol(Math.sin(e*39.425)*15731.7431),i=Ol(Math.sin(e*93.989)*68219.1234);return{rate:.28+t*.78,phase:n*Math.PI*2,depth:.35+r*.65,sizeCoupling:.3+i*.35}}function Al(e,t,n,r=!1){let i=kl(n),a=Math.max(0,Math.min(1,1-t));if(r)return{intensity:1-a*.12,size:1};let o=e/1e3,s=Math.sin(o*i.rate*2*Math.PI+i.phase),c=Math.sin(o*i.rate*.41*2*Math.PI+i.phase*1.7),l=Math.sin(o*i.rate*2.63*2*Math.PI+i.phase*.3),u=s*.55+c*.32+l*.13,d=.14*i.depth*(.55+.9*a);return{intensity:jl(1+u*d,.55,1.45),size:jl(1+u*d*i.sizeCoupling,.7,1.3)}}function jl(e,t,n){return e<t?t:e>n?n:e}var Ml={dark:{floor:.1,gamma:.78,ceiling:.62},light:{floor:.24,gamma:.58,ceiling:.92}};function Nl(e){let t=Fl(e);return 1-.32*t*t}function Pl(e,t=`dark`,n=0){let r=Fl(e);if(r<=0)return 0;let i=Ml[t],a=r**+i.gamma;return Fl((i.floor+(i.ceiling-i.floor)*a)*Nl(n))}function Fl(e){return e<0?0:e>1?1:e}function Il(e,t,n){let r=pl(fl(`starfield:${n}`)),i=new Float32Array(e*3),a=new Float32Array(e),o=new Float32Array(e);for(let n=0;n<e;n++){let e=r(),s=r(),c=t*(.6+.4*r()),l=1-2*e,u=Math.sqrt(Math.max(0,1-l*l)),d=2*Math.PI*s,f=n*3;i[f]=c*u*Math.cos(d),i[f+1]=c*l,i[f+2]=c*u*Math.sin(d),a[n]=.4+r()*1.2;let p=r();o[n]=p*p*p}return{positions:i,sizes:a,tints:o}}var Ll=[`joy`,`calm`,`sadness`,`anger`,`surprise`,`neutral`],Rl=2.5,zl=3,Bl=256,Vl=14,Hl=220,Ul=.7,Wl=.5,Gl=.42,Kl=.72,ql=.42,Jl=.92,Yl=Ll.reduce((e,n)=>{let r=t[n];return e[n]=new Z(r.r,r.g,r.b),e},{}),Xl={r:0,g:0,b:0};function Zl(t,n,r,i){Xl.r=n.r,Xl.g=n.g,Xl.b=n.b;let a=e(Xl,{r:r.r,g:r.g,b:r.b},i);return t.setRGB(a.r,a.g,a.b),t}var Ql=2600,$l=55,eu=new Z(13623295),tu=new Z(16755578),nu=10,ru=new Z(10336488),iu=new Z(15782062),au=new Z(16771016),ou=.024,su=.022,cu=.018;function lu(){let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,0,32,32,32);n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.22,`rgba(255,255,255,0.85)`),n.addColorStop(.55,`rgba(255,255,255,0.28)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64);let r=new Di(e);return r.needsUpdate=!0,r}function uu(){let e=new Map,t=lu();for(let n of Ll){let r=Yl[n];e.set(n,new fr({map:t,color:r,transparent:!0,opacity:.95,blending:2,depthWrite:!1}))}return e}function du(){let{positions:e,sizes:t,tints:n}=Il(Ql,$l,20260808),r=new or;return r.setAttribute(`position`,new Gn(e,3)),r.setAttribute(`size`,new Gn(t,1)),r.setAttribute(`tint`,new Gn(n,1)),new wi(r,new Vi({uniforms:{uCold:{value:new Z(10470655)},uWarm:{value:new Z(16765601)},uTime:{value:0}},vertexShader:`
      ...
      void main() {
        ...
        float w1 = sin(uTime * 0.55 + seed);
        float w2 = sin(uTime * 0.23 + seed * 1.7);
        float w3 = sin(uTime * 0.11 + seed * 3.1);
        float tw = 0.5 + 0.5 * smoothstep(-1.0, 1.0, w1 * 0.6 + w2 * 0.24 + w3 * 0.16);
        float shiver = 0.85 + 0.15 * sin(uTime * 0.3 + seed * 2.3);
        vAlpha = mix(0.72, 0.15, depth) * (0.5 + 0.5 * tw) * shiver * (0.5 + 0.5 * smoothstep(0.35, 1.6, size));
    ...
    `,fragmentShader:`
      ...
      void main() {
        ...
        float halo = (1.0 - r) * 0.30;
        // a fine diffraction cross on the brightest few stars
        vec2 ad = abs(uv) * 2.0;
        float cross = pow(max(0.0, 1.0 - ad.x), 6.0) * 0.5
                   + pow(max(0.0, 1.0 - ad.y), 6.0) * 0.5;
        gl_FragColor = vec4(vColor, (core + halo + cross * 0.35) * vAlpha);
      }
    `,transparent:!0,blending:2,depthWrite:!1}))}function fu(e){let t=new Xc({canvas:e,antialias:!0,alpha:!0,powerPreference:`high-performance`});t.setSize(window.innerWidth,window.innerHeight),t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.toneMapping=4,t.toneMappingExposure=Jl;let n=new fn,r=new fa(60,window.innerWidth/window.innerHeight,.1,100);r.position.set(0,0,5);let i=new al(t);i.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),i.setSize(window.innerWidth,window.innerHeight),i.addPass(new ol(n,r));let a=new cl(new q(window.innerWidth,window.innerHeight),Gl,Kl,ql);i.addPass(a),i.addPass(new ul);let o=uu(),s=new rn;n.add(s);let c=du();s.add(c);let l=o.get(`neutral`).clone(),u=new Er(l);u.scale.setScalar(ou),s.add(u);let d=new Map,f=[],p=[],m=[],h=[];function g(){let e=p.pop();if(e)return e;let t=new fr({transparent:!0,depthWrite:!1}),n=new Er(t),r={sprite:n,material:t};return s.add(n),r}function _(e){e.sprite.visible=!1,p.push(e)}function v(e,t){let n=o.get(t);e.material.map=n.map,e.material.color.copy(n.color),e.material.opacity=n.opacity,e.material.blending=n.blending,e.material.transparent=!0,e.material.depthWrite=!1,e.material.needsUpdate=!0,e.sprite.material=e.material}function y(){for(let e of m)_(e);m.length=0;for(let e of h){let t=g();v(t,e.emotion);let n=Ve(e.hash);t.sprite.position.set(n.x,n.y,n.z),t.sprite.scale.setScalar(cu),t.material.opacity=.28+e.confidence*.2,t.sprite.visible=!0,m.push(t)}}let b=new oi({vertexColors:!0,transparent:!0,opacity:.9,blending:2,depthWrite:!1}),x=new Float32Array(Bl*28*3),S=new Float32Array(Bl*28*3),C=new or,w=new Gn(x,3).setUsage(He),T=new Gn(S,3).setUsage(He);C.setAttribute(`position`,w),C.setAttribute(`color`,T);let E=new vi(C,b);s.add(E);let D=bl(),O=new Z,k=new Z,A=new Z,j={x:0,y:0,z:0},ee={x:0,y:0,z:0},M=Yl.neutral,N=new Map,P=null,F=new J(0,0,0),te=[],ne=!1,re=typeof window<`u`&&window.matchMedia?.(`(prefers-color-scheme: light)`).matches?`light`:`dark`;typeof window<`u`&&window.matchMedia&&window.matchMedia(`(prefers-color-scheme: light)`).addEventListener?.(`change`,e=>{re=e.matches?`light`:`dark`});let ie=0,ae=0,oe=new Map,se=gl(r.aspect),I=se,ce=new oi({vertexColors:!0,transparent:!0,blending:2,depthWrite:!1}),le=new Float32Array(144),ue=new Float32Array(144),de=new or,fe=new Gn(le,3).setUsage(He),pe=new Gn(ue,3).setUsage(He);de.setAttribute(`position`,fe),de.setAttribute(`color`,pe);let me=new vi(de,ce);me.visible=!1,s.add(me);let he=new oi({vertexColors:!0,transparent:!0,blending:2,depthWrite:!1}),ge=new Float32Array(840),_e=new Float32Array(840),ve=new or,ye=new Gn(ge,3).setUsage(He),be=new Gn(_e,3).setUsage(He);ve.setAttribute(`position`,ye),ve.setAttribute(`color`,be);let xe=new vi(ve,he);xe.visible=!1,s.add(xe);let Se=new Z(16767411),Ce=new or,we=new Float32Array(69),Te=new Float32Array(69),Ee=new Gn(we,3).setUsage(He),De=new Gn(Te,3).setUsage(He);Ce.setAttribute(`position`,Ee),Ce.setAttribute(`color`,De);let Oe=new mi(Ce,new oi({vertexColors:!0,transparent:!0,blending:2,depthWrite:!1}));Oe.visible=!1,Oe.frustumCulled=!1,s.add(Oe);let ke=new J,Ae=new J,je=new J,L=0,Me=0,R=1/0,Ne=!1,z=new Z(10470655),Pe=new Z(16765601),B={cold:new Z,warm:new Z},V=0,Fe=[],Ie=[],Le=new Map;function Re(){if(Fe.length===0){me.visible=!1;return}let e=se*1.15;for(let t=0;t<Fe.length;t++){let n=Fe[t],r=t*6;le[r]=n.ax*e,le[r+1]=n.ay*e,le[r+2]=n.az*e,le[r+3]=n.bx*e,le[r+4]=n.by*e,le[r+5]=n.bz*e}fe.needsUpdate=!0,de.setDrawRange(0,Fe.length*2),me.visible=!0}function ze(){if(xe.visible=!1,Ie.length===0)return;let e=Math.min(Ie.length,nu),t={x:F.x,y:F.y,z:F.z};for(let n=0;n<e;n++){let e=Ie[n];Le.has(e.hash)||Le.set(e.hash,Ue(e.hash));let r=Ve(e.hash),i={x:r.x,y:r.y,z:r.z},a={x:0,y:0,z:0},o={x:0,y:0,z:0};Sl(i,t,0,a);for(let e=0;e<Vl;e++){Sl(i,t,(e+1)/Vl,o);let r=n*28*3+e*6;ge[r]=a.x,ge[r+1]=a.y,ge[r+2]=a.z,ge[r+3]=o.x,ge[r+4]=o.y,ge[r+5]=o.z,a.x=o.x,a.y=o.y,a.z=o.z}}ye.needsUpdate=!0,ve.setDrawRange(0,e*28),xe.visible=!0}function Be(){let e=Math.max(0,-V),t=Math.max(0,V);B.cold.copy(z).lerp(Pe,e*.4),B.cold.lerp(eu,t*.5),B.warm.copy(Pe).lerp(z,t*.4),B.warm.lerp(tu,e*.45)}function Ve(e){se!==I&&(oe.clear(),I=se);let t=oe.get(e);return t||(t=ml(e,se),oe.set(e,t)),t}function Ue(e){let t=0;for(let n=0;n<e.length&&n<8;n++)t+=e.charCodeAt(n)*(n+1);return t||1}function We(e,t){let n=N.get(e);return n?Zl(t,M,Yl[n],Ul):t.copy(M)}return{setStar(e){if(P=e,e){let t=Ve(e.hash);F.set(t.x,t.y,t.z),u.position.copy(F),u.visible=!0,ze()}else u.visible=!1,xe.visible=!1},setRemoteStars(e){te=e},setHistoricalStars(e){h=e,y()},setGhostAsterisms(e){Fe=e,Re()},setClimate(e){V=Math.max(-1,Math.min(1,e))},setRemembrance(e){Ie=e,Le.clear();for(let t of e)Le.set(t.hash,Ue(t.hash));ze()},setReducedMotion(e){ne=e},setAmbient(e){re=e},update(e){let t=ie===0?16:Math.min(100,e-ie);ie=e;let n=c.material;if(n.uniforms?.uTime&&(n.uniforms.uTime.value=ne?0:e/1e3),ne)Oe.visible=!1,Ne=!1;else{if(Ne||(R=e+4e4+Math.random()*5e4),Ne=!0,!Oe.visible&&e>=R){R=e+6e4+Math.random()*6e4;let t=Math.random()*Math.PI*2;ke.set(Math.sin(t)*(.22+Math.random()*.18),.66+Math.random()*.1,Math.cos(t)*(.22+Math.random()*.18)).normalize().multiplyScalar(se*1.06),Ae.set(Math.sin(t+2.6)*.14+(Math.random()-.5)*.1,-.92,Math.cos(t+1.4)*.1).normalize(),L=e,Me=920+Math.random()*620,Oe.visible=!0}if(Oe.visible){let t=(e-L)/Me;if(t>=1)Oe.visible=!1;else{let e=t*t,n=.08+.04*t;for(let r=0;r<=22;r++){let i=r/22;je.copy(ke).addScaledVector(Ae,e*se*.52-i*n*se);let a=r*3;we[a]=je.x,we[a+1]=je.y,we[a+2]=je.z;let o=(.04+i*i*.96)*(1-t);De.setXYZ(r,Se.r*o,Se.g*o,Se.b*o)}Ee.needsUpdate=!0,De.needsUpdate=!0,Ce.setDrawRange(0,23)}}}if(Be(),n.uniforms.uCold.value.copy(B.cold),n.uniforms.uWarm.value.copy(B.warm),me.visible&&Fe.length>0){let e=Math.max(0,-V),t=Math.max(0,V);for(let n=0;n<Fe.length;n++){let r=Fe[n],i=new Z(ru).lerp(iu,e*.25),a=r.opacity*(.5+t*.2);ue.set([i.r,i.g,i.b],n*6),ue.set([i.r,i.g,i.b],n*6+3);let o=Math.max(.05,Math.min(1,a));pe.setX(n*6,i.r*o),pe.setY(n*6,i.g*o),pe.setZ(n*6,i.b*o),pe.setX(n*6+3,i.r*o),pe.setY(n*6+3,i.g*o),pe.setZ(n*6+3,i.b*o)}pe.needsUpdate=!0}if(xe.visible&&Ie.length>0){let t=Math.min(Ie.length,nu);for(let n=0;n<t;n++){let t=Ie[n],r=Le.get(t.hash)??1,i=ne?.55:.55+.18*Math.sin(e*.0012+r*.7),a=Math.min(1,i);for(let e=0;e<28;e++){let t=n*28*3+e*3;be.setXYZ(t,au.r*a,au.g*a,au.b*a)}}be.needsUpdate=!0}if(!ne){let t=e/1e3;s.rotation.y=t*.0037,s.rotation.x=Math.sin(t*.0163)*.035+Math.sin(t*.0071+1.3)*.022,s.rotation.z=Math.sin(t*.0094+.6)*.018,r.position.x=Math.sin(t*.045)*.16,r.position.y=Math.sin(t*.031+1.7)*.11,r.lookAt(0,0,0)}if(P){let t=dl(e-P.birthTime,ou),n=Al(e,P.confidence,Ue(P.hash),ne);l.color.copy(Yl[P.emotion]),l.opacity=Math.min(1,(.75+P.confidence*.25)*n.intensity),u.scale.setScalar(t*n.size)}let a=new Set;for(let t of te){if(e-t.lastSeen>3e4)continue;a.add(t.hash);let n=d.get(t.hash);if(!n){n=g(),v(n,t.emotion);let e=Ve(t.hash);n.sprite.position.set(e.x,e.y,e.z),d.set(t.hash,n)}let r=Al(e,t.confidence,Ue(t.hash),ne);n.sprite.scale.setScalar(su*r.size),n.material.opacity=Math.min(1,.95*r.intensity),n.sprite.visible=!0}for(let[t,n]of d)a.has(t)||(d.delete(t),f.push({sprite:n,started:e}));for(let t=f.length-1;t>=0;t--){let{sprite:n,started:r}=f[t],i=(e-r)/500;i>=1?(_(n),f.splice(t,1)):n.sprite.scale.setScalar(Math.max(1e-4,su*(1-i)))}if(e-ae>=Hl){ae=e,N.clear();let t=[];for(let e of te){if(!a.has(e.hash))continue;let n=Ve(e.hash);N.set(e.hash,e.emotion),t.push({id:e.hash,x:n.x,y:n.y,z:n.z})}P&&(N.set(`self`,P.emotion),t.push({id:`self`,x:F.x,y:F.y,z:F.z})),D.sync(yl(t,Rl,zl))}let o=D.step(t),p=Math.min(o.length,Bl);if(p>0){for(let t=0;t<p;t++){let n=o[t],r=Dl(n.a+`|`+n.b),i=ne?-1:El(e,r),a=Pl(n.opacity*Wl,re,p/Bl),s=We(n.a,O),c=We(n.b,k),l=t*28*3;Sl({x:n.ax,y:n.ay,z:n.az},{x:n.bx,y:n.by,z:n.bz},0,ee);for(let e=0;e<Vl;e++){let t=e/Vl,r=(e+1)/Vl;Sl({x:n.ax,y:n.ay,z:n.az},{x:n.bx,y:n.by,z:n.bz},r,j);let o=l+e*6;x[o]=ee.x,x[o+1]=ee.y,x[o+2]=ee.z,x[o+3]=j.x,x[o+4]=j.y,x[o+5]=j.z;for(let e=0;e<2;e++){let l=e===0?t:r,u=a*Cl(l)*wl(l,n.alpha);i>=0&&(u*=Tl(l,i)),Zl(A,s,c,l).multiplyScalar(Math.min(1,u));let d=o+e*3;S[d]=A.r,S[d+1]=A.g,S[d+2]=A.b}ee.x=j.x,ee.y=j.y,ee.z=j.z}}w.needsUpdate=!0,T.needsUpdate=!0,C.setDrawRange(0,p*28),E.visible=!0}else E.visible=!1;i.render()},resize(e,n){if(r.aspect=e/n,r.updateProjectionMatrix(),se=gl(r.aspect),oe.clear(),I=se,P){let e=Ve(P.hash);F.set(e.x,e.y,e.z),u.position.copy(F)}for(let[e,t]of d){let n=Ve(e);t.sprite.position.set(n.x,n.y,n.z)}y(),Re(),ze(),t.setSize(e,n),i.setSize(e,n),a.setSize(e,n)}}}export{fu as createSky};