...
void main() {
    ...
    `,transparent:!0,blending:2,depthWrite:!1}))}function fu(e){let t=new Xc({canvas:e,antialias:!0,alpha:!0,powerPreference:`high-performance`});t.setSize(window.innerWidth,window.innerHeight),t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.toneMapping=4,t.toneMappingExposure=Jl;let n=new fn,r=new fa(60,window.innerWidth/window.innerHeight,.1,100);r.position.set(0,0,5);let i=new al(t);i.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),i.setSize(window.innerWidth,window.innerHeight),i.addPass(new ol(n,r));let a=new cl(new q(window.innerWidth,window.innerHeight),Gl,Kl,ql);i.addPass(a),i.addPass(new ul);let o=uu(),s=new rn;n.add(s);let c=du();s.add(c);let l=o.get(`neutral`).clone(),u=new Er(l);u.scale.setScalar(ou),s.add(u);let d=new Map,f=[],p=[],m=[],h=[];function g(){let e=p.pop();if(e)return e;let t=new fr({transparent:!0,depthWrite:!1}),n=new Er(t),r={sprite:n,material:t};return s.add(n),r}function _(e){e.sprite.visible=!1,p.push(e)}function v(e,t){let n=o.get(t);e.material.map=n.map,e.material.color.copy(n.color),e.material.opacity=n.opacity,e.material.blending=n.blending,e.material.transparent=!0,e.material.depthWrite=!1,e.material.needsUpdate=!0,e.sprite.material=e.material}function y(){for(let e of m)_(e);m.length=0;for(let e of h){let t=g();v(t,e.emotion);let n=L(e.hash);t.sprite.position.set(n.x,n.y,n.z),t.sprite.scale.setScalar(cu),t.material.opacity=.28+e.confidence*.2,t.sprite.visible=!0,m.push(t)}}let b=new oi({vertexColors:!0,transparent:!0,opacity:.9,blending:2,depthWrite:!1}),x=new Float32Array(Bl*28*3),S=new Float32Array(Bl*28*3),C=new or,w=new Gn(x,3).setUsage(He),T=new Gn(S,3).setUsage(He);C.setAttribute(`position`,w),C.setAttribute(`color`,T);let E=new vi(C,b);s.add(E);let D=bl(),O=new Z,k=new Z,A=new Z,j={x:0,y:0,z:0},ee={x:0,y:0,z:0},M=Yl.neutral,N=new Map,P=null,F=new J(0,0,0),te=[],ne=!1,re=typeof window<`u`&&window.matchMedia?.(`(prefers-color-scheme: light)`).matches?`light`:`dark`;typeof window<`u`&&window.matchMedia&&window.matchMedia(`(prefers-color-scheme: light)`).addEventListener?.(`change`,e=>{re=e.matches?`light`:`dark`});let ie=0,ae=0,oe=new Map,se=gl(r.aspect),I=se,ce=new oi({vertexColors:!0,transparent:!0,blending:2,depthWrite:!1}),le=new Float32Array(144),ue=new Float32Array(144),de=new or,fe=new Gn(le,3).setUsage(He),pe=new Gn(ue,3).setUsage(He);de.setAttribute(`position`,fe),de.setAttribute(`color`,pe);let me=new vi(de,ce);me.visible=!1,s.add(me);let he=new oi({vertexColors:!0,transparent:!0,blending:2,depthWrite:!1}),ge=new Float32Array(840),_e=new Float32Array(840),ve=new or,ye=new Gn(ge,3).setUsage(He),be=new Gn(_e,3).setUsage(He);ve.setAttribute(`position`,ye),ve.setAttribute(`color`,be);let xe=new vi(ve,he);xe.visible=!1,s.add(xe);let Se=new Z(10470655),Ce=new Z(16765601),we={cold:new Z,warm:new Z},Te=0,Ee=[],De=[],Oe=new Map;function ke(){if(Ee.length===0){me.visible=!1;return}let e=se*1.15;for(let t=0;t<Ee.length;t++){let n=Ee[t],r=t*6;le[r]=n.ax*e,le[r+1]=n.ay*e,le[r+2]=n.az*e,le[r+3]=n.bx*e,le[r+4]=n.by*e,le[r+5]=n.bz*e}fe.needsUpdate=!0,de.setDrawRange(0,Ee.length*2),me.visible=!0}function Ae(){if(xe.visible=!1,De.length===0)return;let e=Math.min(De.length,nu),t={x:F.x,y:F.y,z:F.z};for(let n=0;n<e;n++){let e=De[n];Oe.has(e.hash)||Oe.set(e.hash,Me(e.hash));let r=L(e.hash),i={x:r.x,y:r.y,z:r.z},a={x:0,y:0,z:0},o={x:0,y:0,z:0};Sl(i,t,0,a);for(let e=0;e<Vl;e++){Sl(i,t,(e+1)/Vl,o);let r=n*28*3+e*6;ge[r]=a.x,ge[r+1]=a.y,ge[r+2]=a.z,ge[r+3]=o.x,ge[r+4]=o.y,ge[r+5]=o.z,a.x=o.x,a.y=o.y,a.z=o.z}}ye.needsUpdate=!0,ve.setDrawRange(0,e*28),xe.visible=!0}function je(){let e=Math.max(0,-Te),t=Math.max(0,Te);we.cold.copy(Se).lerp(Ce,e*.4),we.cold.lerp(eu,t*.5),we.warm.copy(Ce).lerp(Se,t*.4),we.warm.lerp(tu,e*.45)}function L(e){se!==I&&(oe.clear(),I=se);let t=oe.get(e);return t||(t=ml(e,se),oe.set(e,t)),t}function Me(e){let t=0;for(let n=0;n<e.length&&n<8;n++)t+=e.charCodeAt(n)*(n+1);return t||1}function R(e,t){let n=N.get(e);return n?Zl(t,M,Yl[n],Ul):t.copy(M)}return{setStar(e){if(P=e,e){let t=L(e.hash);F.set(t.x,t.y,t.z),u.position.copy(F),u.visible=!0,Ae()}else u.visible=!1,xe.visible=!1},setRemoteStars(e){te=e},setHistoricalStars(e){h=e,y()},setGhostAsterisms(e){Ee=e,ke()},setClimate(e){Te=Math.max(-1,Math.min(1,e))},setRemembrance(e){De=e,Oe.clear();for(let t of e)Oe.set(t.hash,Me(t.hash));Ae()},setReducedMotion(e){ne=e},setAmbient(e){re=e},update(e){let t=ie===0?16:Math.min(100,e-ie);ie=e;let n=c.material;if(n.uniforms?.uTime&&(n.uniforms.uTime.value=ne?0:e/1e3),je(),n.uniforms.uCold.value.copy(we.cold),n.uniforms.uWarm.value.copy(we.warm),me.visible&&Ee.length>0){let e=Math.max(0,-Te),t=Math.max(0,Te);for(let n=0;n<Ee.length;n++){let r=Ee[n],i=new Z(ru).lerp(iu,e*.25),a=r.opacity*(.5+t*.2);ue.set([i.r,i.g,i.b],n*6),ue.set([i.r,i.g,i.b],n*6+3);let o=Math.max(.05,Math.min(1,a));pe.setX(n*6,i.r*o),pe.setY(n*6,i.g*o),pe.setZ(n*6,i.b*o),pe.setX(n*6+3,i.r*o),pe.setY(n*6+3,i.g*o),pe.setZ(n*6+3,i.b*o)}pe.needsUpdate=!0}if(xe.visible&&De.length>0){let t=Math.min(De.length,nu);for(let n=0;n<t;n++){let t=De[n],r=Oe.get(t.hash)??1,i=ne?.55:.55+.18*Math.sin(e*.0012+r*.7),a=Math.min(1,i);for(let e=0;e<28;e++){let t=n*28*3+e*3;be.setXYZ(t,au.r*a,au.g*a,au.b*a)}}be.needsUpdate=!0}if(!ne){let t=e/1e3;s.rotation.y=t*.0037,s.rotation.x=Math.sin(t*.0163)*.035+Math.sin(t*.0071+1.3)*.022,s.rotation.z=Math.sin(t*.0094+.6)*.018,r.position.x=Math.sin(t*.045)*.16,r.position.y=Math.sin(t*.031+1.7)*.11,r.lookAt(0,0,0)}if(P){let t=dl(e-P.birthTime,ou),n=Al(e,P.confidence,Me(P.hash),ne);l.color.copy(Yl[P.emotion]),l.opacity=Math.min(1,(.75+P.confidence*.25)*n.intensity),u.scale.setScalar(t*n.size)}let a=new Set;for(let t of te){if(e-t.lastSeen>3e4)continue;a.add(t.hash);let n=d.get(t.hash);if(!n){n=g(),v(n,t.emotion);let e=L(t.hash);n.sprite.position.set(e.x,e.y,e.z),d.set(t.hash,n)}let r=Al(e,t.confidence,Me(t.hash),ne);n.sprite.scale.setScalar(su*r.size),n.material.opacity=Math.min(1,.95*r.intensity),n.sprite.visible=!0}for(let[t,n]of d)a.has(t)||(d.delete(t),f.push({sprite:n,started:e}));for(let t=f.length-1;t>=0;t--){let{sprite:n,started:r}=f[t],i=(e-r)/500;i>=1?(_(n),f.splice(t,1)):n.sprite.scale.setScalar(Math.max(1e-4,su*(1-i)))}if(e-ae>=Hl){ae=e,N.clear();let t=[];for(let e of te){if(!a.has(e.hash))continue;let n=L(e.hash);N.set(e.hash,e.emotion),t.push({id:e.hash,x:n.x,y:n.y,z:n.z})}P&&(N.set(`self`,P.emotion),t.push({id:`self`,x:F.x,y:F.y,z:F.z})),D.sync(yl(t,Rl,zl))}let o=D.step(t),p=Math.min(o.length,Bl);if(p>0){for(let t=0;t<p;t++){let n=o[t],r=Dl(n.a+`|`+n.b),i=ne?-1:El(e,r),a=Pl(n.opacity*Wl,re,p/Bl),s=R(n.a,O),c=R(n.b,k),l=t*28*3;Sl({x:n.ax,y:n.ay,z:n.az},{x:n.bx,y:n.by,z:n.bz},0,ee);for(let e=0;e<Vl;e++){let t=e/Vl,r=(e+1)/Vl;Sl({x:n.ax,y:n.ay,z:n.az},{x:n.bx,y:n.by,z:n.bz},r,j);let o=l+e*6;x[o]=ee.x,x[o+1]=ee.y,x[o+2]=ee.z,x[o+3]=j.x,x[o+4]=j.y,x[o+5]=j.z;for(let e=0;e<2;e++){let l=e===0?t:r,u=a*Cl(l)*wl(l,n.alpha);i>=0&&(u*=Tl(l,i)),Zl(A,s,c,l).multiplyScalar(Math.min(1,u));let d=o+e*3;S[d]=A.r,S[d+1]=A.g,S[d+2]=A.b}ee.x=j.x,ee.y=j.y,ee.z=j.z}}w.needsUpdate=!0,T.needsUpdate=!0,C.setDrawRange(0,p*28),E.visible=!0}else E.visible=!1;i.render()},resize(e,n){if(r.aspect=e/n,r.updateProjectionMatrix(),se=gl(r.aspect),oe.clear(),I=se,P){let e=L(P.hash);F.set(e.x,e.y,e.z),u.position.copy(F)}for(let[e,t]of d){let n=L(e);t.sprite.position.set(n.x,n.y,n.z)}y(),ke(),Ae(),t.setSize(e,n),i.setSize(e,n),a.setSize(e,n)}}}export{fu as createSky};