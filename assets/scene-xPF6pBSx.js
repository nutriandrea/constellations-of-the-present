...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ao(e,t,n){let r=new Float32Array(Ga),i=new J(0,1,0);return new zi({name:`SphericalGaussianBlur`,defines:{n:Ga,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:co(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function oo(){return new zi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:co(),fragmentShader:`
	...
	`}var lo=class extends wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new wi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};ol.BlurDirectionX=new q(1,0),ol.BlurDirectionY=new q(0,1);var sl={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},cl=class extends Xc{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ii.clone(sl.uniforms),this.material=new Bi({name:sl.name,uniforms:this.uniforms,vertexShader:sl.vertexShader,fragmentShader:sl.fragmentShader}),this._fsQuad=new $c(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},X.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}};new Z(16763210),new Z(10475775),new Z(7044054),new Z(16734798),new Z(14723071),new Z(13621475);function ll(e,t){return t*(1+Math.min(e/6e4,1)*.2)}var ul=[{t:0,color:Sl(16765066)},{t:.14,color:Sl(16748395)},{t:.32,color:Sl(15694502)},{t:.5,color:Sl(11827430)},{t:.7,color:Sl(8031210)},{t:.87,color:Sl(7260648)},{t:1,color:Sl(10475231)}],dl={joy:.03,anger:.15,surprise:.42,sadness:.66,calm:.86,neutral:.98},fl=.46,pl=.72;function ml(e){return e<=.04045?e/12.92:((e+.055)/1.055)**2.4}function hl(e){return wl(e<=.0031308?e*12.92:1.055*e**(1/2.4)-.055)}function gl(e){return .2126*ml(e.r)+.7152*ml(e.g)+.0722*ml(e.b)}function _l(e,t,n){let r=wl(n);return{r:hl(Cl(ml(e.r),ml(t.r),r)),g:hl(Cl(ml(e.g),ml(t.g),r)),b:hl(Cl(ml(e.b),ml(t.b),r))}}function vl(e){let t=wl(e);for(let e=0;e<ul.length-1;e++){let n=ul[e],r=ul[e+1];if(t<=r.t){let e=r.t-n.t,i=e<=0?0:(t-n.t)/e;return _l(n.color,r.color,i)}}return{...ul[ul.length-1].color}}function yl(e,t=fl,n=pl){let r=gl(e);if(r<=0)return{...e};let i=Cl(r,t,wl(n))/r;return{r:hl(ml(e.r)*i),g:hl(ml(e.g)*i),b:hl(ml(e.b)*i)}}function bl(e){return yl(vl(dl[e]))}var xl={joy:bl(`joy`),calm:bl(`calm`),sadness:bl(`sadness`),anger:bl(`anger`),surprise:bl(`surprise`),neutral:bl(`neutral`)};function Sl(e){return{r:(e>>16&255)/255,g:(e>>8&255)/255,b:(e&255)/255}}function Cl(e,t,n){return e+(t-e)*n}function wl(e){return e<0?0:e>1?1:e}function Tl(e){let t=2166136261;for(let n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return t>>>0}function El(e){let t=e;return()=>{t+=1831565813;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function Dl(e,t=2.2){let n=El(Tl(e)),r=n(),i=n(),a=1-2*r,o=Math.sqrt(Math.max(0,1-a*a)),s=2*Math.PI*i;return{x:t*o*Math.cos(s),y:t*a,z:t*o*Math.sin(s)}}var Ol=.85;function kl(e){let t=Math.max(.1,e),n=30*Math.PI/180,r=Math.tan(n)*t;return Math.min(Math.tan(n),r)*5*Ol}var Al=kl(16/9);function jl(e){let t=Math.max(.1,e),n=30*Math.PI/180,r=Math.tan(n)*t;return Al/(Math.min(Math.tan(n),r)*Ol)}function Ml(e,t){return Math.hypot(e.x-t.x,e.y-t.y,e.z-t.z)}function Nl(e,t){return e<t?`${e}|${t}`:`${t}|${e}`}function Pl(e,t,n){let r=new Map;for(let i of e){let a=e.filter(e=>e.id!==i.id).map(e=>({b:e,d:Ml(i,e)})).filter(({d:e})=>e<=t).sort((e,t)=>e.d-t.d||(e.b.id<t.b.id?-1:1)).slice(0,Math.max(1,n));r.set(i.id,a)}let i=[],a=new Set;for(let n of e){let e=r.get(n.id)??[];for(let o=0;o<e.length;o++){let{b:s,d:c}=e[o],l=Nl(n.id,s.id);if(a.has(l))continue;let u=r.get(s.id)??[],d=u.some(e=>e.b.id===n.id),f=o===0,p=u.length>0&&u[0].b.id===n.id;if(!d&&!f&&!p)continue;a.add(l);let m=Math.max(0,1-c/t);i.push({a:n.id,b:s.id,ax:n.x,ay:n.y,az:n.z,bx:s.x,by:s.y,bz:s.z,opacity:m**1.6})}}return i.sort((e,t)=>t.opacity-e.opacity||(Nl(e.a,e.b)<Nl(t.a,t.b)?-1:1)),i}function Fl(e=900,t=1400){let n=new Map;return{sync(e){let t=new Set;for(let r of e){let e=Nl(r.a,r.b);t.add(e);let i=n.get(e);i?(i.connection=r,i.target=1):n.set(e,{connection:r,alpha:0,target:1})}for(let[e,r]of n)t.has(e)||(r.target=0)},step(r){let i=[],a=r/Math.max(1,e),o=r/Math.max(1,t);for(let[e,t]of n){if(t.target>t.alpha?t.alpha=Math.min(1,t.alpha+a):t.target<t.alpha&&(t.alpha=Math.max(0,t.alpha-o)),t.alpha<=0&&t.target===0){n.delete(e);continue}let r=t.alpha*t.alpha*(3-2*t.alpha);i.push({...t.connection,alpha:r})}return i.sort((e,t)=>t.opacity*t.alpha-e.opacity*e.alpha),i},size(){return n.size}}}var Il=.16;function Ll(e,t,n,r={x:0,y:0,z:0}){let i=(e.x+t.x)/2,a=(e.y+t.y)/2,o=(e.z+t.z)/2,s=Math.hypot(e.x-t.x,e.y-t.y,e.z-t.z),c=i,l=a,u=o,d=Math.hypot(c,l,u);d<1e-6&&(c=-(e.y-t.y),l=e.x-t.x,u=0,d=Math.hypot(c,l,u),d<1e-6&&(c=0,l=0,u=1,d=1));let f=s*Il*2/d,p=i+c*f,m=a+l*f,h=o+u*f,g=1-n,_=g*g,v=2*g*n,y=n*n;return r.x=_*e.x+v*p+y*t.x,r.y=_*e.y+v*m+y*t.y,r.z=_*e.z+v*h+y*t.z,r}function Rl(e){return Math.sin(Math.PI*Math.min(1,Math.max(0,e)))**.65}function zl(e,t){return Math.min(1,Math.max(0,(t-e)*7+1))}function Bl(e,t,n=.55){let r=Math.abs(e-t);return r>.5&&(r=1-r),1+n*Math.exp(-(r*r)/.006)}function Vl(e,t,n=5200){let r=Math.abs(Math.sin(t*12.9898))*1e3%1;return((e/n+r)%1+1)%1}function Hl(e){let t=2166136261;for(let n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return(t>>>0)/4294967295}function Ul(e){return e-Math.floor(e)}function Wl(e){let t=Ul(Math.sin(e*12.9898)*43758.5453),n=Ul(Math.sin(e*78.233)*24634.6345),r=Ul(Math.sin(e*39.425)*15731.7431),i=Ul(Math.sin(e*93.989)*68219.1234);return{rate:.28+t*.78,phase:n*Math.PI*2,depth:.35+r*.65,sizeCoupling:.3+i*.35}}function Gl(e,t,n,r=!1){let i=Wl(n),a=Math.max(0,Math.min(1,1-t));if(r)return{intensity:1-a*.12,size:1};let o=e/1e3,s=Math.sin(o*i.rate*2*Math.PI+i.phase),c=Math.sin(o*i.rate*.41*2*Math.PI+i.phase*1.7),l=Math.sin(o*i.rate*2.63*2*Math.PI+i.phase*.3),u=s*.55+c*.32+l*.13,d=.14*i.depth*(.55+.9*a);return{intensity:Kl(1+u*d,.55,1.45),size:Kl(1+u*d*i.sizeCoupling,.7,1.3)}}function Kl(e,t,n){return e<t?t:e>n?n:e}var ql={dark:{floor:.1,gamma:.78,ceiling:.62},light:{floor:.24,gamma:.58,ceiling:.92}};function Jl(e){let t=Xl(e);return 1-.32*t*t}function Yl(e,t=`dark`,n=0){let r=Xl(e);if(r<=0)return 0;let i=ql[t],a=r**+i.gamma;return Xl((i.floor+(i.ceiling-i.floor)*a)*Jl(n))}function Xl(e){return e<0?0:e>1?1:e}function Zl(e,t,n){let r=El(Tl(`starfield:${n}`)),i=new Float32Array(e*3),a=new Float32Array(e),o=new Float32Array(e);for(let n=0;n<e;n++){let e=r(),s=r(),c=t*(.6+.4*r()),l=1-2*e,u=Math.sqrt(Math.max(0,1-l*l)),d=2*Math.PI*s,f=n*3;i[f]=c*u*Math.cos(d),i[f+1]=c*l,i[f+2]=c*u*Math.sin(d),a[n]=.4+r()*1.2;let p=r();o[n]=p*p*p}return{positions:i,sizes:a,tints:o}}var Ql=[`joy`,`calm`,`sadness`,`anger`,`surprise`,`neutral`],$l=2.5,eu=3,tu=256,nu=14,ru=220,iu=.7,au=.5,ou=.42,su=.72,cu=.42,lu=.92,uu=Ql.reduce((e,t)=>{let n=xl[t];return e[t]=new Z(n.r,n.g,n.b),e},{}),du={r:0,g:0,b:0};function fu(e,t,n,r){du.r=t.r,du.g=t.g,du.b=t.b;let i=_l(du,{r:n.r,g:n.g,b:n.b},r);return e.setRGB(i.r,i.g,i.b),e}var pu=2600,mu=55,hu=.024,gu=.022,_u=.018;function vu(){let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,0,32,32,32);n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.22,`rgba(255,255,255,0.85)`),n.addColorStop(.55,`rgba(255,255,255,0.28)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64);let r=new Ti(e);return r.needsUpdate=!0,r}function yu(){let e=new Map,t=vu();for(let n of Ql){let r=uu[n];e.set(n,new ur({map:t,color:r,transparent:!0,opacity:.95,blending:2,depthWrite:!1}))}return e}function bu(){let{positions:e,sizes:t,tints:n}=Zl(pu,mu,20260808),r=new ir;return r.setAttribute(`position`,new Un(e,3)),r.setAttribute(`size`,new Un(t,1)),r.setAttribute(`tint`,new Un(n,1)),new Si(r,new zi({uniforms:{uCold:{value:new Z(10470655)},uWarm:{value:new Z(16765601)},uTime:{value:0}},vertexShader:`
      ...
      void main() {
        ...
        // Sfondo ridotto: le stelle di fondo restano un velo discreto, così le
        // presenze live (colorate) sono il vero protagonista del cielo.
        vAlpha = mix(0.26, 0.07, depth) * tw * (0.5 + 0.5 * smoothstep(0.4, 1.6, size));
    ...
    `,transparent:!0,blending:2,depthWrite:!1}))}function xu(e){let t=new Jc({canvas:e,antialias:!0,alpha:!0,powerPreference:`high-performance`});t.setSize(window.innerWidth,window.innerHeight),t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.toneMapping=4,t.toneMappingExposure=lu;let n=new un,r=new ua(60,window.innerWidth/window.innerHeight,.1,100);r.position.set(0,0,jl(r.aspect));let i=new rl(t);i.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),i.setSize(window.innerWidth,window.innerHeight),i.addPass(new il(n,r));let a=new ol(new q(window.innerWidth,window.innerHeight),ou,su,cu);i.addPass(a),i.addPass(new cl);let o=yu(),s=new tn;n.add(s);let c=bu();s.add(c);let l=o.get(`neutral`).clone(),u=new wr(l);u.scale.setScalar(hu),s.add(u);let d=new Map,f=[],p=[],m=[],h=[];function g(){let e=p.pop();if(e)return e;let t=new ur({transparent:!0,depthWrite:!1}),n=new wr(t),r={sprite:n,material:t,bucket:null};return s.add(n),r}function _(e){e.sprite.visible=!1,p.push(e)}function v(e,t){if(e.bucket===t)return;let n=o.get(t);e.material.map=n.map,e.material.color.copy(n.color),e.material.opacity=n.opacity,e.material.blending=n.blending,e.material.transparent=!0,e.material.depthWrite=!1,e.material.needsUpdate=!0,e.sprite.material=e.material,e.bucket=t}function y(){for(let e of m)_(e);m.length=0;for(let e of h){let t=g();v(t,e.emotion);let n=L(e.hash);t.sprite.position.set(n.x,n.y,n.z),t.sprite.scale.setScalar(_u),t.material.opacity=.28+e.confidence*.2,t.sprite.visible=!0,m.push(t)}}let b=new ii({vertexColors:!0,transparent:!0,opacity:.9,blending:2,depthWrite:!1}),x=new Float32Array(tu*28*3),S=new Float32Array(tu*28*3),C=new ir,w=new Un(x,3).setUsage(ze),T=new Un(S,3).setUsage(ze);C.setAttribute(`position`,w),C.setAttribute(`color`,T);let E=new gi(C,b);s.add(E);let D=Fl(),O=new Z,k=new Z,A=new Z,j={x:0,y:0,z:0},M={x:0,y:0,z:0},N=uu.neutral,P=new Map,F=null,I=new J(0,0,0),ee=[],te=!1,ne=typeof window<`u`&&window.matchMedia?.(`(prefers-color-scheme: light)`).matches?`light`:`dark`;typeof window<`u`&&window.matchMedia&&window.matchMedia(`(prefers-color-scheme: light)`).addEventListener?.(`change`,e=>{ne=e.matches?`light`:`dark`});let re=0,ie=0,ae=new Map,oe=Al;function L(e){let t=ae.get(e);return t||(t=Dl(e,oe),ae.set(e,t)),t}function se(e){let t=0;for(let n=0;n<e.length&&n<8;n++)t+=e.charCodeAt(n)*(n+1);return t||1}function ce(e,t){let n=P.get(e);return n?fu(t,N,uu[n],iu):t.copy(N)}return{setStar(e){if(F=e,e){let t=L(e.hash);I.set(t.x,t.y,t.z),u.position.copy(I),u.visible=!0}else u.visible=!1},setRemoteStars(e){ee=e},setHistoricalStars(e){h=e,y()},setReducedMotion(e){te=e},setAmbient(e){ne=e},update(e){let t=re===0?16:Math.min(100,e-re);re=e;let n=c.material;if(n.uniforms?.uTime&&(n.uniforms.uTime.value=te?0:e/1e3),!te){let t=e/1e3;s.rotation.y=t*.0037,s.rotation.x=Math.sin(t*.0163)*.035+Math.sin(t*.0071+1.3)*.022,s.rotation.z=Math.sin(t*.0094+.6)*.018,r.position.x=Math.sin(t*.045)*.16,r.position.y=Math.sin(t*.031+1.7)*.11,r.lookAt(0,0,0)}if(F){let t=ll(e-F.birthTime,hu),n=Gl(e,F.confidence,se(F.hash),te);l.color.copy(uu[F.emotion]),l.opacity=Math.min(1,(.75+F.confidence*.25)*n.intensity),u.scale.setScalar(t*n.size)}let a=new Set;for(let t of ee){if(e-t.lastSeen>3e4)continue;a.add(t.hash);let n=d.get(t.hash);if(!n){n=g();let e=L(t.hash);n.sprite.position.set(e.x,e.y,e.z),d.set(t.hash,n)}v(n,t.emotion);let r=Gl(e,t.confidence,se(t.hash),te);n.sprite.scale.setScalar(gu*r.size),n.material.opacity=Math.min(1,.95*r.intensity),n.sprite.visible=!0}for(let[t,n]of d)a.has(t)||(d.delete(t),f.push({sprite:n,started:e}));for(let t=f.length-1;t>=0;t--){let{sprite:n,started:r}=f[t],i=(e-r)/500;i>=1?(_(n),f.splice(t,1)):n.sprite.scale.setScalar(Math.max(1e-4,gu*(1-i)))}if(e-ie>=ru){ie=e,P.clear();let t=[];for(let e of ee){if(!a.has(e.hash))continue;let n=L(e.hash);P.set(e.hash,e.emotion),t.push({id:e.hash,x:n.x,y:n.y,z:n.z})}F&&(P.set(`self`,F.emotion),t.push({id:`self`,x:I.x,y:I.y,z:I.z})),D.sync(Pl(t,$l,eu))}let o=D.step(t),p=Math.min(o.length,tu);if(p>0){for(let t=0;t<p;t++){let n=o[t],r=Hl(n.a+`|`+n.b),i=te?-1:Vl(e,r),a=Yl(n.opacity*au,ne,p/tu),s=ce(n.a,O),c=ce(n.b,k),l=t*28*3;Ll({x:n.ax,y:n.ay,z:n.az},{x:n.bx,y:n.by,z:n.bz},0,M);for(let e=0;e<nu;e++){let t=e/nu,r=(e+1)/nu;Ll({x:n.ax,y:n.ay,z:n.az},{x:n.bx,y:n.by,z:n.bz},r,j);let o=l+e*6;x[o]=M.x,x[o+1]=M.y,x[o+2]=M.z,x[o+3]=j.x,x[o+4]=j.y,x[o+5]=j.z;for(let e=0;e<2;e++){let l=e===0?t:r,u=a*Rl(l)*zl(l,n.alpha);i>=0&&(u*=Bl(l,i)),fu(A,s,c,l).multiplyScalar(Math.min(1,u));let d=o+e*3;S[d]=A.r,S[d+1]=A.g,S[d+2]=A.b}M.x=j.x,M.y=j.y,M.z=j.z}}w.needsUpdate=!0,T.needsUpdate=!0,C.setDrawRange(0,p*28),E.visible=!0}else E.visible=!1;i.render()},resize(e,n){if(r.aspect=e/n,r.updateProjectionMatrix(),r.position.z=jl(r.aspect),F){let e=L(F.hash);I.set(e.x,e.y,e.z),u.position.copy(I)}for(let[e,t]of d){let n=L(e);t.sprite.position.set(n.x,n.y,n.z)}y(),t.setSize(e,n),i.setSize(e,n),a.setSize(e,n)}}}export{xu as createSky};